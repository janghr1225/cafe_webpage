  ...
  data: [
    {
      ...
      //이미지 태그
      img: "../menu_Drinks/1_premiumBlendAmericano.png",
      allergen: "",
    },
    {
      //2
      ...
      img: "../menu_Drinks/2_cafeLatte.png",
    ...
    },
    {
      ...
      //이미지 태그
      img: "../menu_Drinks/3_coldBrewLatte.png",
      allergen: "알레르기 유발요인 : 우유",
    },
    {
      //4
      ...
      description: "콜드브루 커피의 풍부한 풍미와 우유의 고소함이 더해진 라떼",
      //이미지 태그
      img: "../menu_Drinks/4_decafvanilladelight.png",
    ...
    },
    {
      ...
      //이미지 태그
      img: "../menu_Drinks/5_cafeMocha.png",
      allergen: "알레르기 유발요인 : 우유, 대두",
    },
    {
      //6
      ...
      //이미지 태그
      img: "../menu_Drinks/6_cappucino.png",
      allergen: "알레르기 유발요인 : 우유",
    },
    {
      name: "카라멜 마키아또", //이름
      ...
      //이미지 태그
      img: "../menu_Drinks/7_caramelmacchiato.png",
      allergen: "알레르기 유발요인 : 우유",
    },
    {
      //8
      ...
      //이미지 태그
      img: "../menu_Drinks/8_espresso.png",
      allergen: "",
    },
    ////////////////////////////////////////////////라떼 티 subtype
    {
    ...
    },
    {
      ...
      //이미지 태그
      img: "../menu_Drinks/10_redGrapeFruitTea.png",
      allergen: "",
    },
    {
      //11
      ...
      description:
        "강렬한 첫 맛, 풍부한 바디감, 깔끔한 뒷 맛이 특징인 커피의 심장",
      //이미지 태그
      img: "../menu_Drinks/11_greenTeaLatte.png",
      allergen: "알레르기 유발요인 : 우유",
    },
    {
      //12
      ...
      //이미지 태그
      img: "../menu_Drinks/12_peachEarlgrey.png",
    ...
    ////////////////////////////////////////////////마할로치노 빙수 subtype
    {
      ...
      //이미지 태그
      img: "../menu_Drinks/13_peachSmoothie.png",
      allergen: "알레르기 유발요인 : 복숭아",
    },
    {
      //14
      ...
      //이미지 태그
      img: "../menu_Drinks/14_waterMelonSmoothie.png",
      allergen: "알레르기 유발요인 : 우유, 대두",
    },
    {
      //15
      ...
      //이미지 태그
      img: "../menu_Drinks/15_darkChococcino.png",
      allergen: "알레르기 유발요인 : 우유, 대두",
    },
    {
      //16
      ...
      //이미지 태그
      img: "../menu_Drinks/16_mintChococcino.png",
      allergen: "알레르기 유발요인 : 우유, 대두",
    },
    {
      //17
      ...
      //이미지 태그
      img: "../menu_Drinks/17_peachStraberricino.png",
      allergen: "알레르기 유발요인 : 복숭아",
    },
    {
      //18
      ...
      //이미지 태그
      img: "../menu_Drinks/18_redBean.png",
    ...
    },
    {
      ...
      //이미지 태그
      img: "../menu_Drinks/19_appleMangoSnow.png",
    ...
    },
    {
      ...
      //이미지 태그
      img: "../menu_Drinks/20_greenticcino.png",
      allergen: "알레르기 유발요인 : 우유,대두",
    },
  ],
};
...
chkbx[0].addEventListener("click", () => {
  if (chkbx[0].checked == true) {
    ...
    drinkListWrap.style.display = "none";
  }
});
//[커피 선택]
