...
const allCoffee = function () {
  ...
  const arrImgCoff = [];
  drinkMenu.data.forEach((obj) => {
    if (JSON.stringify(obj.subtype) == '"샐러드•샌드위치 "') {
      let imgStr = JSON.stringify(obj.img);
      let imgStrR = imgStr.replace(/"/g, "");
...
const allTea = function () {
  ...
  const arrImgTea = [];
  drinkMenu.data.forEach((obj) => {
    if (JSON.stringify(obj.subtype) == '"브레드"') {
      let imgStr = JSON.stringify(obj.img);
      let imgStrR = imgStr.replace(/"/g, "");
...
const allFrozen = function () {
  ...
  const arrImgFro = [];
  drinkMenu.data.forEach((obj) => {
    if (JSON.stringify(obj.subtype) == '"케이크"') {
      let imgStr = JSON.stringify(obj.img);
      let imgStrR = imgStr.replace(/"/g, "");
...
const allCof_Tea = function () {
  ...
  // chkbx[3].checked = false;
  showDrinkList.innerHTML = "";
  const arrCNames = []; //////////////////////////////////////샐러드•샌드위치 이름 배열 arrCNames
  drinkMenu.data.forEach((obj) => {
    if (JSON.stringify(obj.subtype) == '"샐러드•샌드위치 "') {
      let imgStr = JSON.stringify(obj.name);
      let imgStrR = imgStr.replace(/"/g, "");
  ...
  const arrTCimgs = []; ///////////////////////////////////////////샐러드•샌드위치  + 브레드 이미지배열 arrT
  drinkMenu.data.forEach((obj) => {
    if (
      JSON.stringify(obj.subtype) == '"샐러드•샌드위치 "' ||
      JSON.stringify(obj.subtype) == '"브레드"'
    ) {
      let imgStr = JSON.stringify(obj.img);
      let imgStrR = imgStr.replace(/"/g, "");
  ...
  console.log(arrTCimgs); //8(샐러드•샌드위치 )+4(티)
  //json 라떼티 이름 뽑아오기
...
const allCof_Fro = function () {
  ...
  const arrCFimgs = []; ///////////////////////////////////////////샐러드•샌드위치  + 마할로치노 이미지배열 arrT
  drinkMenu.data.forEach((obj) => {
    if (
      JSON.stringify(obj.subtype) == '"샐러드•샌드위치 "' ||
      JSON.stringify(obj.subtype) == '"케이크"'
    ) {
      let imgStr = JSON.stringify(obj.img);
      let imgStrR = imgStr.replace(/"/g, "");
  ...
  console.log(arrCFimgs); //8(샐러드•샌드위치 )+4(티)
  //json 라떼티 이름 뽑아오기
...
const allTea_Fro = function () {
  ...
  chkbx[3].checked = true;
  showDrinkList.innerHTML = "";
  const arrTNames = []; //////////////////////////////////////샐러드•샌드위치 이름 배열 arrCNames
  drinkMenu.data.forEach((obj) => {
    if (JSON.stringify(obj.subtype) == '"브레드"') {
      let imgStr = JSON.stringify(obj.name);
      let imgStrR = imgStr.replace(/"/g, "");
  ...
  console.log(arrFNames);
  const arrTFimgs = []; ///////////////////////////////////////////샐러드•샌드위치  + 마할로치노 이미지배열 arrT
  drinkMenu.data.forEach((obj) => {
    if (
      JSON.stringify(obj.subtype) == '"브레드"' ||
      JSON.stringify(obj.subtype) == '"케이크"'
  ...
  console.log(arrTFimgs); //8(샐러드•샌드위치 )+4(티)
  //json 라떼티 이름 뽑아오기
...
chkbx[1].addEventListener("click", () => {
  ...
  if (
    ...
    //빙수,샐러드•샌드위치  checked> 떄샐러드•샌드위치  빙수 보기
    chkbx[1].checked == true &&
    chkbx[2].checked == false &&
    chkbx[3].checked == true
  ) {
    ...
    // 샐러드•샌드위치 ,티 checked> 샐러드•샌드위치  uncheck > 티만 보이기
    chkbx[1].checked == true &&
    chkbx[2].checked == true &&
    chkbx[3].checked == false
  ) {
    ...
    //샐러드•샌드위치 ,빙수 checked> 샐러드•샌드위치  uncheck > 빙수만 보이기
    chkbx[1].checked == false &&
    chkbx[2].checked == false &&
    chkbx[3].checked == true
  ) {
    allFrozen();
    console.log("샐러드•샌드위치  취소했을 때 빙수만 보이기!@@@");
  } else if (
    //샐러드•샌드위치 ,티 checked > 샐러드•샌드위치  취소했을 때 티
    chkbx[1].checked == false &&
    chkbx[2].checked == true &&
    chkbx[3].checked == false
  ) {
...
chkbx[3].addEventListener("click", () => {
  if (chkbx[0].checked == true) {
    ...
    // 샐러드•샌드위치  checked > 샐러드•샌드위치  + 빙수 보이기
    chkbx[1].checked == true &&
    chkbx[2].checked == false &&
    chkbx[3].checked == true
  ) {
